      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            <span className="text-[#D29D69] dark:text-[#F8BB7C]">Contáctanos</span>
          </h2>
          <div className="w-24 h-1 bg-[#D29D69] dark:bg-[#F8BB7C] mx-auto mb-6"></div>
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            Estamos listos para ayudarte con tus proyectos de telecomunicaciones. Ponte en contacto con nosotros.
          </p>
        </div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#D29D69]/10 dark:bg-[#F8BB7C]/10 flex items-center justify-center text-[#D29D69] dark:text-[#F8BB7C]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  required
                  className="border-gray-300 dark:border-gray-700 focus:border-[#D29D69] dark:focus:border-[#F8BB7C] focus:ring-[#D29D69] dark:focus:ring-[#F8BB7C]"
                />
              </div>
              <div>
              ...
              <Button
                type="submit"
                className="w-full bg-[#D29D69] hover:bg-[#c08b5a] text-white dark:bg-[#F8BB7C] dark:hover:bg-[#e9ac6d] dark:text-gray-900"
              >
