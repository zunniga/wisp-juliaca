...
const FirstSection = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#20252b] text-gray-800 dark:text-gray-100 ">
      {/* Features Section */}
      <div className="container mx-auto px-6 pt-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {/* Video Training Card */}
          <div className="group relative p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-[#A1D302] transition-all duration-500 bg-white/80 dark:bg-gray-800/30 backdrop-blur-sm">
          ...
          {/* Expert Teacher Card */}
          <div className="group relative p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-[#00a9bb] transition-all duration-500 bg-white/80 dark:bg-gray-800/30 backdrop-blur-sm">
          ...
          <div className="group relative p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-[#006174] transition-all duration-500 bg-white/80 dark:bg-gray-800/30 backdrop-blur-sm">
